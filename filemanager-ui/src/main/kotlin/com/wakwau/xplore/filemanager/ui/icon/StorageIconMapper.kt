...
// [Penjelasan]: Mengecek apakah item berkas adalah root internal storage secara dinamis menggunakan Environment API dan konstanta terpusat.
...
object StorageIconMapper {
    fun isInternalStorage(item: FileItem): Boolean {
        ...
        return item.location.path.equals(primaryPath, ignoreCase = true) ||
               ...
               item.name.equals("Penyimpanan Internal", ignoreCase = true)
    }
}
