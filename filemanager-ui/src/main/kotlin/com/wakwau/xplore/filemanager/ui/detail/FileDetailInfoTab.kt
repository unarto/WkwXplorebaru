...
fun FileDetailInfoTab(
    ...
    val parentPath = metadata?.parentPath ?: (File(filePath).parent ?: "")
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        FileDetailRow(
            ...
            value = fileName,
            actionIcon = Icons.Default.ContentCopy,
            actionContentDescription = stringResource(R.string.cd_copy_value, stringResource(R.string.label_name_colon)),
            onActionClick = { copyToClipboard(fileName, context.getString(R.string.label_name_colon)) }
        )
